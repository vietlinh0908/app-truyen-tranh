...
public class Noidungtruyen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvContact.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Noidungtruyen2.this, "Bạn đang đọc truyện songoku", Toast.LENGTH_SHORT).show();
            }
        });
    }

    public void initData() {
        listContact.add(new ContactModel( R.drawable.songoku1));
        listContact.add(new ContactModel( R.drawable.songoku2));
        listContact.add(new ContactModel( R.drawable.songoku3));
        listContact.add(new ContactModel( R.drawable.songoku4));
        listContact.add(new ContactModel( R.drawable.songoku5));
